...
pub fn interpret(command: &str) -> Vec<u16> {
    ...
    match command_parts[0] {
        ...
        "LDo" => machine_instruction = mem_access::ldo(command_parts),
        "STo" => machine_instruction = mem_access::sto(command_parts),
        "LDr" => machine_instruction = mem_access::ldr(command_parts),
        "STr" => machine_instruction = mem_access::str(command_parts),
        "LDoa" => machine_instruction = mem_access::ldoa(command_parts),
        "SToa" => machine_instruction = mem_access::stoa(command_parts),
        "LDra" => machine_instruction = mem_access::ldra(command_parts),
        "STra" => machine_instruction = mem_access::stra(command_parts),
        "LDob" => machine_instruction = mem_access::ldob(command_parts),
        "STob" => machine_instruction = mem_access::stob(command_parts),
        "LDrb" => machine_instruction = mem_access::ldrb(command_parts),
        "STrb" => machine_instruction = mem_access::strb(command_parts),
